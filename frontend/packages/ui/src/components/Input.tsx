...
function Input({ className, size = 'default', unstyled = false, ...props }: InputProps) {
  return (
    ...
    >
      <InputPrimitive
        className={cn(
          'w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)] outline-hidden placeholder:text-muted-foreground/64',
