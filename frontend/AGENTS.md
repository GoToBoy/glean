...
Frontend-specific guidance for agents working on the web app, admin dashboard, and shared packages.

For repo-wide guidance, see [../AGENTS.md](../AGENTS.md). Authoritative spec lives in [`../docs/`](../docs/).
